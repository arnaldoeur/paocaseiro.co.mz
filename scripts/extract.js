...
fs.writeFileSync('c:/Users/arnal/Downloads/paocaseiro.co.mz-20260317T132532Z-1-001/paocaseiro.co.mz/paocaseiro.co.mz/correct_menu.json', JSON.stringify(menuObj, null, 2));
console.log('Successfully extracted ' + menuObj.length + ' categories.');
