...
var addPointerInfo = (handler) => {
  return (event) => isPrimaryPointer2(event) && handler(event, extractEventInfo(event));
};
  ...
  constructor() {
    ...
    this.startPointerPress = (startEvent, startInfo) => {
      ...
      const endPointerPress = (endEvent, endInfo) => {
        ...
        const handler = !globalTapTarget && !isNodeOrChild2(this.node.current, endEvent.target) ? onTapCancel : onTap;
        if (handler) {
