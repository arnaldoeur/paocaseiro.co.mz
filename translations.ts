            ...
            sections: [
                {
                    title: 'Pizzaria',
                    items: [
                        { name: 'Pizza mexicana', price: 700, image: '/images/pao_caseiro.png', desc: '', variations: [{ name: "Medium", price: 0 }, { name: "Large", price: 250 }] },
                        { name: 'Pizza de frango', price: 700, image: '/images/pao_caseiro.png', desc: '', variations: [{ name: "Medium", price: 0 }, { name: "Large", price: 250 }] },
                        { name: 'Pizza de peperoni', price: 700, image: '/images/pao_caseiro.png', desc: '', variations: [{ name: "Medium", price: 0 }, { name: "Large", price: 250 }] },
                        { name: 'Pizza 4 estacões', price: 700, image: '/images/pao_caseiro.png', desc: '', variations: [{ name: "Medium", price: 0 }, { name: "Large", price: 250 }] },
                        { name: 'Pizza de palony', price: 700, image: '/images/pao_caseiro.png', desc: '', variations: [{ name: "Medium", price: 0 }, { name: "Large", price: 250 }] },
                        { name: 'Mini pizza diversos un', price: 50, image: '/images/pao_caseiro.png', desc: '', variations: [{ name: "Medium", price: 0 }, { name: "Large", price: 250 }] },
                    ]
                },
                {
                    title: 'Lanches',
                    items: [
                        { name: 'Cachorro quente completo', price: 300, image: '/images/cachorro_quente.png', desc: 'Soft bun with sausage and condiments of choice.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Hambúrguer completo', price: 350, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Shawarma de galinha', price: 300, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Shawarma de carne', price: 350, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Cachorro quente', price: 250, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Hambúrguer simples', price: 300, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                    ]
                },
                {
                    title: 'Cafés',
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { name: 'Cakes / fatias', price: 150, image: '/images/cakes.png', desc: 'Generous slice of homemade cake.' },
                        { name: 'Fatias xadrez', price: 150, image: '/images/fatias_xadrez.png', desc: 'Fun cake with a two-flavor checkerboard pattern.' },
                        { name: 'Pastel de nata', price: 80, image: '/images/pastel_nata.png', desc: 'The ex-libris of Portuguese sweets: puff pastry and creamy egg custard.' },
                        { name: 'Bolo de arroz', price: 65, image: '/images/bolo_arroz.png', desc: 'Traditional cake made with rice flour, with a unique texture.' },
                        { name: 'Donuts', price: 80, image: '/images/donuts.png', desc: 'Fried dough with classic sweet glaze.' },
                        { name: 'Charruto recheado', price: 80, image: '/images/pao_caseiro.png', desc: '' },
                        { name: 'Pudim', price: 600, image: '/images/pudim.png', desc: 'Homemade egg pudding, smooth and topped with caramel.' },
                        { name: 'Queques', price: 65, image: '/images/queques.png', desc: 'Simple and fluffy individual cake, perfect for a snack.' },
                        { name: 'Palmier recheado', price: 100, image: '/images/palmier_recheado.png', desc: 'Two layers of palmier filled with sweet cream.' },
                        { name: 'Torta', price: 150, image: '/images/torta.png', desc: 'Sweet homemade roll, perfect with coffee.' },
                        { name: 'Waffle stick', price: 0, image: '/images/waffle_stick.png', desc: 'Delicious waffle on a stick, crispy outside and soft inside.' },
                        ...
                        { name: 'Nevada', price: 80, image: '/images/nevada.png', desc: 'Fluffy cake topped with white cream and coconut.' },
                        ...
                        { name: 'Bola de berlim', price: 80, image: '/images/bola_berlim.png', desc: 'Fluffy fried dough, filled with our homemade pastry cream.' },
                ...
                },
                {
                    ...
                    items: [
                        { name: 'Folhado de salsicha', price: 70, image: '/images/folhado_salsicha.png', desc: 'Tasty sausage wrapped in golden puff pastry.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Mini pizza', price: 50, image: '/images/pizza_mexicana.png', desc: 'Small individual pizza with cheese and tomato sauce.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Samosas / chamussas (50 cada)', price: 50, image: '/images/samosas.png', desc: 'Typical triangular pastry with spiced filling.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Rissóis de camarão', price: 50, image: '/images/rissois_camarao.png', desc: 'Breaded half-moon with creamy shrimp filling.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Almofadinha', price: 50, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Calzone', price: 80, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Chamussas de frango', price: 50, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Chamussas de vegetais', price: 40, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Empadas', price: 100, image: '/images/empadas.png', desc: 'Tender shortcrust pastry with creamy filling.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Empada de carne', price: 100, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Folhados de carne', price: 100, image: '/images/folhados_carne.png', desc: 'Well-seasoned minced meat filling in puff pastry.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Croissants simples', price: 60, image: '/images/croissants_simples.png', desc: 'Brioche-type croissant, soft and tasty.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Croissants chocolate', price: 80, image: '/images/croissants_chocolate.png', desc: 'Filled with rich chocolate cream.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Coxinhas', price: 50, image: '/images/coxinhas.png', desc: 'Traditional savory with creamy filling and crispy dough.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Empadas de frango', price: 100, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Rissois', price: 50, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'King pie frango/carne', price: 100, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Mini subs', price: 60, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Folhado salsicha com queijo', price: 70, image: '/images/folhado_salsicha_queijo.png', desc: 'The classic sausage puff pastry with a touch of melted cheese.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Folhados recheados', price: 80, image: '/images/folhados_recheados.png', desc: 'Variety of puff pastries with delicious fillings.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Mini folhados (kg)', price: 1000, image: '/images/mini_folhados.png', desc: 'Assortment of small puff pastries, ideal for parties and snacks.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Folhados de salchicha', price: 70, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Croissants recheados', price: 80, image: '/images/croissants_recheados.png', desc: 'Croissant with special sweet filling.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Pie de vegetais', price: 100, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Chamussas de peixe', price: 40, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Croissants folhados', price: 100, image: '/images/croissants_folhados.png', desc: 'Classic puff pastry croissant, light and buttery.', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                        { name: 'Chamussas de carne', price: 50, image: '/images/pao_caseiro.png', desc: '', complements: [{ name: "Soft drink", price: 50 }, { name: "Extra cheese", price: 50 }, { name: "Fries", price: 100 }, { name: "Extra fries", price: 150 }, { name: "Salad", price: 50 }] },
                    ]
                },
                {
                    title: 'Pães',
                    items: [
                        ...
                        { name: 'Pão caseiro', price: 10, image: '/images/pao_caseiro.png', desc: 'Our traditional bread, fresh anytime.' },
                        { name: 'Pao de deus', price: 60, image: '/images/pao_caseiro.png', desc: '' },
                        { name: 'Pão português', price: 10, image: '/images/pao_portugues.png', desc: 'Authentic Portuguese recipe, with a crispy crust and soft crumb.' },
                        ...
                        { name: 'Broa de milho', price: 20, image: '/images/broa_milho.png', desc: 'Dense and tasty cornbread, made with corn flour.' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { name: 'Língua de sogra', price: 15, image: '/images/lingua_sogra.png', desc: 'Long and soft cake with cream.' },
                        { name: 'Arrofadas', price: 15, image: '/images/arrofadas.png', desc: 'Traditional sweet bread, soft and lightly sugared.' },
                        { name: 'Charuto', price: 80, image: '/images/charuto.png', desc: 'Crispy rolled pastry with sweet filling.' },
                        { name: 'Laços', price: 60, image: '/images/lacos.png', desc: 'Sugared puff pastry in a bow shape, light and crispy.' },
                        { name: 'Rolo de açúcar e canela', price: 80, image: '/images/rolo_acucar_canela.png', desc: 'Sweet dough swirls with the warm aroma of cinnamon.' },
                        { name: 'Pão de deus', price: 60, image: '/images/pao_deus.png', desc: 'Fluffy brioche bread with crispy coconut topping.' },
