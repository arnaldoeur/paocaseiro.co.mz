            ...
            sections: [
                {
                    title: 'Pizzaria',
                    items: [
                        { name: 'Pizza mexicana', price: 700, image: '/paocaseiropng.png', desc: '', variations: [{ name: "Média", price: 0 }, { name: "Grande", price: 250 }] },
                        { name: 'Pizza de frango', price: 700, image: '/paocaseiropng.png', desc: '', variations: [{ name: "Média", price: 0 }, { name: "Grande", price: 250 }] },
                        { name: 'Pizza de peperoni', price: 700, image: '/paocaseiropng.png', desc: '', variations: [{ name: "Média", price: 0 }, { name: "Grande", price: 250 }] },
                        { name: 'Pizza 4 estacões', price: 700, image: '/paocaseiropng.png', desc: '', variations: [{ name: "Média", price: 0 }, { name: "Grande", price: 250 }] },
                        { name: 'Pizza de palony', price: 700, image: '/paocaseiropng.png', desc: '', variations: [{ name: "Média", price: 0 }, { name: "Grande", price: 250 }] },
                        { name: 'Mini pizza diversos un', price: 50, image: '/paocaseiropng.png', desc: '', variations: [{ name: "Média", price: 0 }, { name: "Grande", price: 250 }] },
                    ]
                },
                {
                    title: 'Lanches',
                    items: [
                        ...
                        { name: 'Hambúrguer completo', price: 350, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Shawarma de galinha', price: 300, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Shawarma de carne', price: 350, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Cachorro quente', price: 250, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Hambúrguer simples', price: 300, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                    ]
                },
                {
                    title: 'Cafés',
                    items: [
                        { name: 'Cappuccino', price: 200, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Hot chocolate', price: 200, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Café pingado', price: 150, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Café especial', price: 150, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Café gelado', price: 150, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Café espresso', price: 100, image: '/paocaseiropng.png', desc: '' },
                    ]
                },
                {
                    title: 'Chás',
                    items: [
                        { name: 'Chá simples', price: 70, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Chá de leite', price: 150, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Chá especial', price: 80, image: '/paocaseiropng.png', desc: '' },
                    ]
                },
                {
                    title: 'Bolos & Sobremesas',
                    items: [
                        { name: 'Cupcake normal', price: 65, image: '/paocaseiropng.png', desc: '' },
                        ...
                        { name: 'Charruto recheado', price: 80, image: '/paocaseiropng.png', desc: '' },
                        ...
                        { name: 'Folhado recheado', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Beijinhos de coco', price: 120, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Biscoitos amanteigados', price: 120, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Caracol de canela', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Croisant recheado', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Bolo t26', price: 2500, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Bolo t22', price: 1850, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pasteis de coco', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Guardanapo recheado c/ creme', price: 150, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Brioche de frutas', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Broche rechado', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Bolo t14', price: 750, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Mini folhados grama', price: 1.2, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Nevada', price: 80, image: '/images/nevada.png', desc: 'Bolo fofo coberto com creme branco e coco.' },
                        { name: 'Bolo t18', price: 1350, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Croisant simples', price: 60, image: '/paocaseiropng.png', desc: '' },
                        ...
                        { name: 'Fatias normal', price: 150, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Palmier simples', price: 50, image: '/paocaseiropng.png', desc: '' },
                    ]
                },
                {
                    ...
                    items: [
                        ...
                        { name: 'Almofadinha', price: 50, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Calzone', price: 80, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Chamussas de frango', price: 50, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Chamussas de vegetais', price: 40, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        ...
                        { name: 'Empada de carne', price: 100, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        ...
                        { name: 'Empadas de frango', price: 100, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Rissois', price: 50, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'King pie frango/carne', price: 100, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Mini subs', price: 60, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        ...
                        { name: 'Folhados de salchicha', price: 70, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        ...
                        { name: 'Pie de vegetais', price: 100, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        { name: 'Chamussas de peixe', price: 40, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                        ...
                        { name: 'Chamussas de carne', price: 50, image: '/paocaseiropng.png', desc: '', complements: [{ name: "Refresco", price: 50 }, { name: "Mais queijo", price: 50 }, { name: "Batata Frita", price: 100 }, { name: "Dose extra de batata", price: 150 }, { name: "Salada", price: 50 }] },
                    ]
                },
                {
                    title: 'Pães',
                    items: [
                        { name: 'Pao normal 50g', price: 5, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao portugues', price: 20, image: '/paocaseiropng.png', desc: '' },
                        ...
                        { name: 'Mini pao de forma 250g', price: 30, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Lingua da sogra 80g', price: 15, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Novo pao 2', price: 50, image: 'https://bqiegszufcqimlvucrpm.supabase.co/storage/v1/object/public/products/1772385996431.jpg', desc: '' },
                        { name: 'Manteiguinha clover 7g', price: 20, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Arrofadas 80g', price: 15, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pão integral', price: 12, image: '/images/pao_integral.png', desc: 'Rico em fibras, para uma alimentação mais saudável.' },
                        { name: 'Baguete frances', price: 70, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pão de forma integral', price: 80, image: '/images/pao_forma_integral.png', desc: 'Ideal para sandes equilibradas e saudáveis.' },
                        { name: 'Mini pao de forma intergral 250g', price: 40, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pão caseiro', price: 10, image: '/images/pao_caseiro.png', desc: 'O nosso pão tradicional, fresco a toda a hora.' },
                        { name: 'Pao de deus', price: 60, image: '/paocaseiropng.png', desc: '' },
                        ...
                        { name: 'Pao de forma 500g', price: 60, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao de forma cereais', price: 50, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao de forma integral 500g', price: 80, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao caserio 100g', price: 10, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao de centeio', price: 35, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao caseiro grande', price: 40, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao de humbuger/ cachoro', price: 15, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao integral peq', price: 10, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Paozinho de leite 100g', price: 15, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao de cereais c/ sementes', price: 40, image: '/paocaseiropng.png', desc: '' },
                        ...
                        { name: 'Pao de agua', price: 15, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao normal 80g', price: 8, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao cassete', price: 16, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Pao crocodilo', price: 30, image: '/paocaseiropng.png', desc: '' },
                        { name: 'Saco de torrada', price: 20, image: '/paocaseiropng.png', desc: '' },
                    ]
                },
                {
