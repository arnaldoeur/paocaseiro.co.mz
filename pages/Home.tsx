...
export const Home: React.FC<HomeProps> = ({ language }) => {
    ...
    useEffect(() => {
        // Keep the showcase gallery locked to the hand-crafted list of classics (breads, sweets, savories)
        // to avoid loading incorrect images, soft drinks, or placeholder images from database updates.
