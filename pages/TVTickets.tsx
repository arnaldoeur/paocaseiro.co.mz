...
export const TVTickets: React.FC = () => {
    ...
    const speak = (text: string) => {
        ...
        // Find a natural PT voice if available
    ...
    useEffect(() => {
        ...
        // Auto-enable audio context on FIRST click to satisfy browser policy invisibly
    ...
    useEffect(() => {
        if (lastCalled) {
            ...
            if (currentUpdate !== lastUpdateRef.current) {
                ...
                if (isAudioEnabled) {
                    console.log("DEBUG: Playing announcement for", lastCalled.ticket_number);
                    ...
                    setTimeout(() => {
                        speak(`Senha ${ticketLabel}, dirija-se ao ${counterLabel}`);
                    }, 800);
                }
            }
        }
    }, [lastCalled, isAudioEnabled]);
                     ...
                     <div className="flex-1 bg-white/[0.02] rounded-[3.5rem] border border-white/5 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 p-6 grid grid-cols-3 gap-6">
                            {waitingNext.map((t, idx) => (
                                ...
                                >
                                    <span className="text-4xl font-black font-mono text-white/40">{t.ticket_number}</span>
                     ...
                     <div className="flex-[1.5] bg-black/40 rounded-[3.5rem] border border-white/5 flex flex-col overflow-hidden shadow-inner">
                        ...
                        <div className="flex-1 p-6 space-y-4 overflow-hidden">
                             {callingTickets.slice(1, 5).map((t, idx) => (
                                 ...
                                 >
                                     <span className="text-4xl font-black font-mono text-white/70">{t.ticket_number}</span>
